...
export function generateMonthlyPDF(accounts: Account[], month: number, year: number, day?: number) {
  ...
  accounts.forEach(acc => {
    ...
    autoTable(doc, {
      ...
      bodyStyles: { fontSize: 8.5, textColor: [30, 30, 30], font: "helvetica", halign: "center", valign: "middle", lineWidth: 0.15, lineColor: [210, 215, 225] },
      columnStyles: {
        0: { halign: "center", cellWidth: 26 },
        1: { halign: "center", fontStyle: "normal" },
        2: { halign: "center", textColor: [5, 150, 105], cellWidth: 32 },
        3: { halign: "center", textColor: [185, 28, 28], cellWidth: 32 },
        4: { halign: "center", fontStyle: "bold", textColor: [30, 58, 95], cellWidth: 35 },
      },
      margin: { left: margin, right: margin },
    });
  });
